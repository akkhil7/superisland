...
final class ChromeIntegration: ObservableObject {
    ...
    /// Everything Klip can do without the user: install the native host
    ...
    private static let manifestFileName = "com.useklip.chrome_bridge.json"

    /// NativeMessagingHosts dirs for the Chrome-family browsers Klip supports.
...
enum ChromeIntegrationError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .missingHostExecutable:
            return "KlipChromeNativeHost is missing from the app bundle."
        case .chromeNotFound:
