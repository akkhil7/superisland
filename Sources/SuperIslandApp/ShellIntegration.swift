...
final class ShellIntegration: ObservableObject {
    ...
    static let configDir = FileManager.default.homeDirectoryForCurrentUser
        .appendingPathComponent(".config/superisland")
    static let zshScriptPath = configDir.appendingPathComponent("superisland.zsh")
    static let bashScriptPath = configDir.appendingPathComponent("superisland.bash")

    // Checked synchronously by adapters at drop-drop time.
