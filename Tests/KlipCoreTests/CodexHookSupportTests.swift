...
final class CodexHookSupportTests: XCTestCase {
    ...
    func testActiveWorkspaceRootsParsing() {
        let json = #"{"active-workspace-roots":["/Users/akhil/useklip"],"project-order":[]}"#
        XCTAssertEqual(
    ...
    func testCwdWorkspaceMatching() {
        let roots = ["/Users/akhil/useklip"]
        XCTAssertTrue(CodexWorkspaceState.cwd("/Users/akhil/useklip", isUnderAnyOf: roots))
        XCTAssertTrue(CodexWorkspaceState.cwd("/Users/akhil/useklip/Sources", isUnderAnyOf: roots))
        // Sibling with a shared prefix must NOT match.
        XCTAssertFalse(CodexWorkspaceState.cwd("/Users/akhil/useklip-v2", isUnderAnyOf: roots))
        XCTAssertFalse(CodexWorkspaceState.cwd("/Users/akhil/whizibility", isUnderAnyOf: roots))
    }

    func testRolloutCwdFromHead() {
        let head = """
        {"type":"session_meta","payload":{"id":"019ead9f","timestamp":"2026-06-09","cwd":"/Users/akhil/useklip"}}
        {"type":"turn_context","payload":{"turn_id":"t1","cwd":"/Users/akhil/useklip"}}
        """
        XCTAssertEqual(CodexRollout.cwd(fromHead: head), "/Users/akhil/useklip")
    ...
    func testInstallAndUninstallRoundTrip() {
        let script = "/Users/x/.config/klip/klip-codex-hook.sh"
